(function(){
    ...
    var IdeaObject = function(parent){
        this.parent = parent;
        this.handles = [];
        this._transform = "";
    ...
    IdeaObject.prototype = {
        constructor: IdeaObject,
        transform: Idea.Util.getterSetter("transform", Idea.Validators.transformValidator, null),
        destroy: function(){
