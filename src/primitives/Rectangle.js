(function(){
    var xGetterSetter = Idea.Util.getterSetter("x", Idea.Validators.intValidator, null);
    var yGetterSetter = Idea.Util.getterSetter("y", Idea.Validators.intValidator, null);
    var widthGetterSetter = Idea.Util.getterSetter("width", Idea.Validators.intValidator, null);
    var heightGetterSetter = Idea.Util.getterSetter("height", Idea.Validators.intValidator, null);
    var rxGetterSetter = Idea.Util.getterSetter("rx", Idea.Validators.uintValidator, null);
    var ryGetterSetter = Idea.Util.getterSetter("ry", Idea.Validators.uintValidator, null);
    var strokeGetterSetter = Idea.Util.getterSetter("stroke", Idea.Validators.colorValidator, null);
    var fillGetterSetter = Idea.Util.getterSetter("fill", Idea.Validators.colorValidator, null);
     ...
     * @param father       Util.Object, parental to Rectangle, or Util.Canvas,
    ...
    Idea.Util.extend(Rectangle, Idea.Object);
    ...
    Idea.ObjectsRegistry["Primitives"].push(Rectangle);
