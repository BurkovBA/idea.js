(function(){
    ...
    /**
     *
     * icon represents an Idea.Object on the objects creation bar of toolbar (so, it actually
    ...
    /**
    *
    * Context represents the state of edited or created Idea.Object or their group. E.g. for a Line it contains
    ...
    */
    ...
    Context.prototype = {
        ...
        /*
         * Context switch happens when a new set of Objects is selected via idea.selection(newSetOfObjects).
    ...
    var Toolbar = function(idea){
        ...
        for (var i=0; i<Idea.ObjectsRegistry["Primitives"].length; i++){
            var obj = Idea.ObjectsRegistry["Primitives"][i];
